...
### Merged
- Merge pull request #219 from henningkayser/pr-fix-service-node-shutdown by @Oberacda in [#219](https://github.com/fzi-forschungszentrum-informatik/ros2_ros_bt_py/pull/219)
...
- Update random_number nodes. by @Oberacda
- Update passthrough node. by @Oberacda
- Update parallel nodes. by @Oberacda
- Update maths nodes. by @Oberacda
- Update list nodes. by @Oberacda
- Update io nodes. by @Oberacda
- Update getter nodes. by @Oberacda
- Update format nodes. by @Oberacda
- Update fallback node. by @Oberacda
- Update decorator node. by @Oberacda
- Update Constant node. by @Oberacda
- Update service. by @Oberacda
- Update node config. by @Oberacda
...
- Update Sequence node. by @Oberacda
- Update CI for new requirement. by @Oberacda
- Switch subtree manager from exceptions to result types. by @Oberacda
- Switch tree node from exceptions to result types. by @Oberacda
- Switch tree_manager from exceptions to result types. by @Oberacda
- Switch node from Exceptions to Result types. by @Oberacda
...
- Beginn rework using result types. by @Oberacda
...
- Fix issues with @typechecked annotation in node.py by @Oberacda
...
- Merge branch 'dev' into fb_rework_error_handling by @Oberacda
